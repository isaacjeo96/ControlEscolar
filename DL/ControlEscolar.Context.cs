...
namespace DL
{
    ...
    public partial class ControlEscolarEntities : DbContext
    {
        ...
        public virtual ObjectResult<MateriasGetNoAsignadas_Result1> MateriasGetNoAsignadas(Nullable<int> idAlumno)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MateriasGetNoAsignadas_Result1>("MateriasGetNoAsignadas", idAlumnoParameter);
        }
    
        public virtual ObjectResult<MateriaGetByIdAlumno_Result1> MateriaGetByIdAlumno(Nullable<int> idAlumno)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MateriaGetByIdAlumno_Result1>("MateriaGetByIdAlumno", idAlumnoParameter);
        }
